...
public class SistemaPrincipal {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("Tesla é um Veiculo? " +
                (tesla instanceof Veiculo)); // true

        System.out.println("Tesla é Recarregavel? " +
                (tesla instanceof Recarregavel)); // true

        // Celular NÃO é Veiculo, MAS é Recarregavel
        System.out.println("Celular é um Veiculo? " +
                (Veiculo.class.isInstance(iphone))); // false

        System.out.println("Celular é Recarregavel? " +
                (iphone instanceof Recarregavel)); // true
